export const DeleteButton=({text}:any)=>{
    return(
        <div>
            <button type="button" className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">{text}</button>
        </div>
    )
}

export const Generate=({onClick,text}:any)=>{
    return(
...
export const AddWallet=({text,onClick}:any)=>{
    return(
        <button type="button" onClick={onClick} className="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
            {text}
        </button>
    )
}

export const ClearWallet=({text,onClick}:any)=>{
    return(
        <button type="button"  onClick={onClick}   className="text-white-900 bg-red-700 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
            {text}
        </button>
    )
}

export const SendMoney=({text,onClick}:any)=>{
    return(
